#!/bin/bash
# =============================================================================
# CM4 Lab 01 - Share your Mac's internet with the CM4 over Ethernet  (macOS)
# =============================================================================
#   [ CM4 ] --ethernet--> [ your Mac ] --wifi--> [ internet ]
#
# USAGE
...
# Use this script when you need the CM4 on a specific subnet instead.
# =============================================================================
...
LAN_IF="en5"                 # interface TO THE CM4      (Ethernet adapter)
HOST_IP="192.168.0.1"        # this Mac's address on the CM4 link = the CM4's GATEWAY
...
set -u
ANCHOR=/etc/pf.anchors/cm4-share
PFCONF=/etc/pf-cm4-share.conf
...
echo "    cm4 on       : $LAN_IF  ($HOST_IP)"
echo "    cm4 subnet   : $LAN_SUBNET"
...
nat-anchor "cm4-share"
rdr-anchor "com.apple/*"
dummynet-anchor "com.apple/*"
anchor "com.apple/*"
load anchor "com.apple" from "/etc/pf.anchors/com.apple"
load anchor "cm4-share" from "$ANCHOR"
PFRULES
...
-----------------------------------------------------------------------
 ...
 On the CM4, give eth0 a static IP that uses this laptop as gateway.
 Edit the SETTINGS block of setup_network.sh:

     ETH_ADDRESS="192.168.0.12/24"
     ETH_GATEWAY="$HOST_IP"
