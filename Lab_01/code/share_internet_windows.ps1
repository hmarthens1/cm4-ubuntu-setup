# =============================================================================
# CM4 Lab 01 - Share your laptop's internet with the CM4 over Ethernet  (WINDOWS)
# =============================================================================
#   [ CM4 ] --ethernet--> [ your laptop ] --wifi--> [ internet ]
#
...
#                   to 192.168.137.1, so the CM4 must use a 192.168.137.x
...
$LanAdapter = "Ethernet"         # adapter TO THE CM4
...
# both methods agree and the CM4's static IP never has to change.
$HostIP       = "192.168.137.1"      # this laptop's address = the CM4's GATEWAY
$LanSubnet    = "192.168.137.0/24"   # must match the CM4's static IP range
$PrefixLength = 24
$NatName      = "CM4Share"
# -----------------------------------------------------------------------------
...
if ($Method -eq "ICS") {
    ...
    $lanCfg.EnableSharing(1)   # 1 = PRIVATE (the side with the CM4)
...
-----------------------------------------------------------------------
 ...
 On the CM4, give eth0 a static IP that matches this laptop.
